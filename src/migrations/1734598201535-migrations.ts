...
export class Migrations1734598201535 implements MigrationInterface {
  name = 'Migrations1734598201535';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."redacao_statusenvio_enum" AS ENUM('rascunho', 'enviado')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."redacao_statuscorrecao_enum" AS ENUM('nao_corrigida', 'corrigida')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TYPE "public"."redacao_statuscorrecao_enum"`);
    await queryRunner.query(`DROP TYPE "public"."redacao_statusenvio_enum"`);
  }
}
